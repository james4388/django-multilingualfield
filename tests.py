...
def main(db_engine='sqlite3'):
    ...
    global_settings.SECRET_KEY = '222ebe58-a77d-4321-fa01-a7d2cb7d3eea'
    global_settings.COVERAGE_REPORT_HTML_OUTPUT_DIR = os.path.join(BASE_PATH, '.coverage')
    global_settings.COVERAGE_USE_STDOUT = True
    global_settings.COVERAGE_PATH_EXCLUDES = ['.hg', '.git', 'templates', 'tests', 'sql', '__pycache__']
    ...
    failures = test_runner.run_tests(['multilingualfield'])
